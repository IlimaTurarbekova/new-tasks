...
public class Main {
	...
	public static void main(String[] args) {
		...
		*/
		...
		if(distance1 < distance2){
			System.out.println(
					"Первая точка ближе первой. Дистанция равна " + minimumDistance
			);
		} else if (distance2 < distance1){
			System.out.println(
					"Вторая точка ближе первой. Дистанция равна " + minimumDistance
			);
		} else {
			System.out.println(
					"Обе точки равноудалены. Дистанция равна " + minimumDistance
			);
		}
	}
